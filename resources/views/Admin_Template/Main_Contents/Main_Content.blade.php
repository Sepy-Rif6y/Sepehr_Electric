        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item active">داشبورد اصلی</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
                ...
                <div class="small-box bg-info">
                    <div class="inner">
                        @foreach ($Categories as $item)
                            ...
                            @break
                        @endforeach
                        <p>تعداد دسته بندی های موجود</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-bag"></i>
                    </div>
                    <a href="{{route('Categories-List')}}" class="small-box-footer">اطلاعات بیشتر <i class="fa fa-arrow-circle-left"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-2 col-6">
                <!-- تعداد مدیران ثبت شده و اتصال به صفحه نمایش لیست مدیران -->
                <div class="small-box bg-success">
                    ...
                    <a href="{{route('Admins-list')}}" class="small-box-footer">اطلاعات بیشتر <i class="fa fa-arrow-circle-left"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-4 col-6">
                ...
                <div class="small-box bg-dark">
                    ...
                    <a href="{{route('Products-List')}}" class="small-box-footer">اطلاعات بیشتر <i class="fa fa-arrow-circle-left"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-2 col-6">
                <!-- تعداد کاربران ثبت شده و اتصال به صفحه لیست کاربران  -->
                <div class="small-box bg-warning">
                    ...
                    <a href="{{route('Users-List')}}" class="small-box-footer">اطلاعات بیشتر <i class="fa fa-arrow-circle-left"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-2 col-6">
                <!-- تعدا کارخانه های ثبت شده -->
                <div class="small-box bg-danger">
                    <div class="inner">
                        @foreach ($Factories as $item)
                            ...
                            @break
                        @endforeach
                        <p>تعداد کارخانه های موجود</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-pie-graph"></i>
                    </div>
                    <a href="{{route('Factories-List')}}" class="small-box-footer">اطلاعات بیشتر <i class="fa fa-arrow-circle-left"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
